import{bg as m,ar as d,m as y,n as l,o as e,q as f,K as g}from"./index-DxcUdtz3.js";import"./vendor-react-CYSfZuHu.js";const c=[{id:"terms",title:"Terms of Service",icon:"📜",blurb:"The rules that govern your use of InterviewIQ.",updatedAt:"2026-08-12"},{id:"privacy",title:"Privacy Policy",icon:"🔒",blurb:"What data we store, what we never collect, and your rights.",updatedAt:"2026-08-12"},{id:"refunds",title:"Refund & Cancellation",icon:"💸",blurb:"How refunds and subscription cancellations work.",updatedAt:"2026-08-12"},{id:"shipping",title:"Shipping Policy",icon:"📦",blurb:"Delivery terms for this digital product.",updatedAt:"2026-08-12"}],v=`## Acceptance of Terms
...
Questions about these Terms: **{{email}}**`,w=`## Overview
...
Privacy questions: **{{email}}**`,b=`## Our promise
...
Payments are processed by Razorpay. Their terms and refund handling also apply to the transaction itself.`,x=`## Digital product — no physical shipping
...
Because the product is digital, the same instant-delivery terms apply to every country. Any applicable taxes or currency conversion are handled by the payment provider at checkout.`,k={terms:v,privacy:w,refunds:b,shipping:x},T=()=>{var o;return typeof window<"u"&&((o=window.location)!=null&&o.origin)?window.location.origin:"https://gaurav123337.github.io/interviewiq"};function P(o){return o.replace(/\{\{company\}\}/g,d.productName).replace(/\{\{url\}\}/g,T()).replace(/\{\{email\}\}/g,d.supportEmail)}function A(o){var a;const r=(a=m().policies)==null?void 0:a[o];return P(r&&r.trim()?r:k[o])}function I(o){const r=o.split(`
`).map(a=>a.trim()).filter(Boolean);return r.length?r[0].startsWith("## ")?e.jsx("h2",{className:"mt-6 text-[17px] font-extrabold tracking-tight first:mt-0",children:r[0].slice(3)}):r.every(a=>a.startsWith("- "))?e.jsx("ul",{className:"mt-2 space-y-1.5 pl-1",children:r.map((a,n)=>e.jsx("li",{className:"flex gap-2 text-[13.5px] leading-relaxed text-fnt before:mt-[7px] before:h-[5px] before:w-[5px] before:flex-none before:rounded-full before:bg-acc3/70",children:e.jsx("span",{children:u(a.slice(2))})},n))}):e.jsx("p",{className:"mt-2 text-[13.5px] leading-relaxed text-fnt",children:u(r.join(" "))}):null}function u(o){return o.split("**").map((a,n)=>n%2===1?e.jsx("strong",{className:"font-extrabold text-ink",children:a},n):e.jsx("span",{children:a},n))}function N(){const{nav:o}=y(),r=()=>{const t=window.location.hash.replace("#","");return c.some(i=>i.id===t)?t:"terms"},[a,n]=l.useState(r);l.useEffect(()=>{const t=()=>n(r());return window.addEventListener("hashchange",t),()=>window.removeEventListener("hashchange",t)},[]);const p=t=>{window.location.hash=t,n(t),window.scrollTo({top:0})},s=c.find(t=>t.id===a),h=A(a).split(/\n{2,}/);return e.jsxs("div",{className:"anim-view mx-auto w-full max-w-[820px]",children:[e.jsxs("div",{className:"flex flex-wrap items-end justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-[11.5px] font-extrabold uppercase tracking-wider text-acc3",children:"Legal"}),e.jsxs("h1",{className:"mt-1 text-[clamp(22px,4vw,30px)] font-extrabold tracking-tight",children:[s.icon," ",s.title]}),e.jsxs("p",{className:"mt-1 text-[12.5px] text-mut",children:[s.blurb," · Updated ",s.updatedAt]})]}),e.jsx("button",{className:"rounded-xl border border-line/15 bg-wht/10 px-3.5 py-1.5 text-[12.5px] font-bold text-mut transition-all hover:bg-wht/20 hover:text-ink",onClick:()=>o("landing"),children:"← Back to home"})]}),e.jsxs("div",{className:"mt-4 flex flex-wrap items-center gap-2 rounded-xl border border-ok/30 bg-ok/10 px-4 py-2.5 text-[12px] text-fnt",children:[e.jsx("span",{className:"font-extrabold text-ok",children:"✓"}),e.jsx("span",{children:"All four required pages are published — Terms, Privacy, Refund & Cancellation, and Shipping. This satisfies the payment-provider requirement for accepting payments (including international cards)."})]}),e.jsx("div",{className:"mt-5 flex flex-wrap gap-2",children:c.map(t=>e.jsxs("button",{onClick:()=>p(t.id),className:`rounded-xl px-3.5 py-2 text-[12.5px] font-bold transition-all ${a===t.id?"grad-bg-soft border border-acc1/40 text-acctxt":"border border-line/15 bg-wht/10 text-mut hover:bg-wht/20 hover:text-ink"}`,children:[t.icon," ",t.title]},t.id))}),e.jsxs("div",{className:`${f} mt-4 p-6 sm:p-8`,children:[h.map((t,i)=>e.jsx("div",{children:I(t)},i)),e.jsxs("div",{className:"mt-8 border-t border-line/10 pt-4 text-[11.5px] text-mut",children:[e.jsxs(g,{tone:"ok",children:["EFFECTIVE ",s.updatedAt]}),e.jsxs("span",{className:"ml-2",children:["© ",new Date().getFullYear()," InterviewIQ. Questions? ",e.jsx("span",{className:"font-bold text-ink",children:"gaurav.123337@gmail.com"})]})]})]})]})}export{N as Legal};

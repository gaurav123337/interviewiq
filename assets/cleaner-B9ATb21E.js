import{aC as m,F as a,L as c}from"./index-DF8zK1pl.js";const f=new Set(a.map(t=>t.id)),u=new Set(c.map(t=>t.id));var l;const y=`You are a senior interview question curator. Convert the raw material below into a

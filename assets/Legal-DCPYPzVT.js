import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{i as t,t as n}from"./vendor-react-Bes57Kji.js";import{l as r}from"./remoteConfig-Btxyhe6x.js";import{t as i}from"./config-DcXWDvMg.js";import"./cloud-Be_vI-RX.js";import{n as a}from"./store-CtSuvADs.js";import{h as o,w as s}from"./ui-Cuv6JFOE.js";var c=e(t(),1),l=[{id:`terms`,title:`Terms of Service`,icon:`📜`,blurb:`The rules that govern your use of InterviewIQ.`,updatedAt:`2026-08-12`},{id:`privacy`,title:`Privacy Policy`,icon:`🔒`,blurb:`What data we store, what we never collect, and your rights.`,updatedAt:`2026-08-12`},{id:`refunds`,title:`Refund & Cancellation`,icon:`💸`,blurb:`How refunds and subscription cancellations work.`,updatedAt:`2026-08-12`},{id:`shipping`,title:`Shipping Policy`,icon:`📦`,blurb:`Delivery terms for this digital product.`,updatedAt:`2026-08-12`}],u={terms:`## Acceptance of Terms
...
Questions about these Terms: **{{email}}**`,privacy:`## Overview
...
Privacy questions: **{{email}}**`,refunds:`## Our promise
...
Payments are processed by Razorpay. Their terms and refund handling also apply to the transaction itself.`,shipping:`## Digital product — no physical shipping
...
Because the product is digital, the same instant-delivery terms apply to every country. Any applicable taxes or currency conversion are handled by the payment provider at checkout.`},d=()=>typeof window<`u`&&window.location?.origin?window.location.origin:`https://gaurav123337.github.io/interviewiq`;function f(e){return e.replace(/\{\{company\}\}/g,i.productName).replace(/\{\{url\}\}/g,d()).replace(/\{\{email\}\}/g,i.supportEmail)}function p(e){let t=r().policies?.[e];return f(t&&t.trim()?t:u[e])}var m=n();function h(e){let t=e.split(`
`).map(e=>e.trim()).filter(Boolean);return t.length?t[0].startsWith(`## `)?(0,m.jsx)(`h2`,{className:`mt-6 text-[17px] font-extrabold tracking-tight first:mt-0`,children:t[0].slice(3)}):t.every(e=>e.startsWith(`- `))?(0,m.jsx)(`ul`,{className:`mt-2 space-y-1.5 pl-1`,children:t.map((e,t)=>(0,m.jsx)(`li`,{className:`flex gap-2 text-[13.5px] leading-relaxed text-fnt before:mt-[7px] before:h-[5px] before:w-[5px] before:flex-none before:rounded-full before:bg-acc3/70`,children:(0,m.jsx)(`span`,{children:g(e.slice(2))})},t))}):(0,m.jsx)(`p`,{className:`mt-2 text-[13.5px] leading-relaxed text-fnt`,children:g(t.join(` `))}):null}function g(e){return e.split(`**`).map((e,t)=>t%2==1?(0,m.jsx)(`strong`,{className:`font-extrabold text-ink`,children:e},t):(0,m.jsx)(`span`,{children:e},t))}function _(){let{nav:e}=a(),t=()=>{let e=window.location.hash.replace(`#`,``);return l.some(t=>t.id===e)?e:`terms`},[n,r]=(0,c.useState)(t);(0,c.useEffect)(()=>{let e=()=>r(t());return window.addEventListener(`hashchange`,e),()=>window.removeEventListener(`hashchange`,e)},[]);let i=e=>{window.location.hash=e,r(e),window.scrollTo({top:0})},u=l.find(e=>e.id===n),d=p(n).split(/\n{2,}/);return(0,m.jsxs)(`div`,{className:`anim-view mx-auto w-full max-w-[820px]`,children:[(0,m.jsxs)(`div`,{className:`flex flex-wrap items-end justify-between gap-3`,children:[(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`span`,{className:`text-[11.5px] font-extrabold uppercase tracking-wider text-acc3`,children:`Legal`}),(0,m.jsxs)(`h1`,{className:`mt-1 text-[clamp(22px,4vw,30px)] font-extrabold tracking-tight`,children:[u.icon,` `,u.title]}),(0,m.jsxs)(`p`,{className:`mt-1 text-[12.5px] text-mut`,children:[u.blurb,` · Updated `,u.updatedAt]})]}),(0,m.jsx)(`button`,{className:`rounded-xl border border-line/15 bg-wht/10 px-3.5 py-1.5 text-[12.5px] font-bold text-mut transition-all hover:bg-wht/20 hover:text-ink`,onClick:()=>e(`landing`),children:`← Back to home`})]}),(0,m.jsxs)(`div`,{className:`mt-4 flex flex-wrap items-center gap-2 rounded-xl border border-ok/30 bg-ok/10 px-4 py-2.5 text-[12px] text-fnt`,children:[(0,m.jsx)(`span`,{className:`font-extrabold text-ok`,children:`✓`}),(0,m.jsx)(`span`,{children:`All four required pages are published — Terms, Privacy, Refund & Cancellation, and Shipping. This satisfies the payment-provider requirement for accepting payments (including international cards).`})]}),(0,m.jsx)(`div`,{className:`mt-5 flex flex-wrap gap-2`,children:l.map(e=>(0,m.jsxs)(`button`,{onClick:()=>i(e.id),className:`rounded-xl px-3.5 py-2 text-[12.5px] font-bold transition-all ${n===e.id?`grad-bg-soft border border-acc1/40 text-acctxt`:`border border-line/15 bg-wht/10 text-mut hover:bg-wht/20 hover:text-ink`}`,children:[e.icon,` `,e.title]},e.id))}),(0,m.jsxs)(`div`,{className:`${s} mt-4 p-6 sm:p-8`,children:[d.map((e,t)=>(0,m.jsx)(`div`,{children:h(e)},t)),(0,m.jsxs)(`div`,{className:`mt-8 border-t border-line/10 pt-4 text-[11.5px] text-mut`,children:[(0,m.jsxs)(o,{tone:`ok`,children:[`EFFECTIVE `,u.updatedAt]}),(0,m.jsxs)(`span`,{className:`ml-2`,children:[`© `,new Date().getFullYear(),` InterviewIQ. Questions? `,(0,m.jsx)(`span`,{className:`font-bold text-ink`,children:`gaurav.123337@gmail.com`})]})]})]})]})}export{_ as Legal};
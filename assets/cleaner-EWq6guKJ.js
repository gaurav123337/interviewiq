import{t as e}from"./data-DMLj1ZLf.js";import{t}from"./levels-DvemuOtu.js";import{n}from"./ai-BkJhQIBU.js";var r=new Set(e.map(e=>e.id)),i=new Set(t.map(e=>e.id)),a=`You are a senior interview question curator. Convert the raw material below into a

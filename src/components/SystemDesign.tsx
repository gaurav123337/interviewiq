...
import { loadCompleted, markCompleted, loadQuiz, saveQuiz, loadHistory, saveHistoryEntry, loadBookmarks, loadTimerPreset, saveTimerPreset, loadFlashcards, calculateStreak, CATEGORY_META } from "./system-design/utils";
import type { CompletedMap, QuizState, QuizHistoryEntry } from "./system-design/utils";



import { LEVELS, LEVEL_INDEX } from "../data";import { SYSTEM_DESIGN_CASES, getCategories, casesByCategory, type SystemDesignCase } from "../data/systemDesignBank";
...
import { TimedPractice } from "./system-design/TimedPractice";
import { StatsDrawer } from "./system-design/StatsDrawer";
import { FlashcardDrawer } from "./system-design/FlashcardDrawer";

  ...
  return (
    <details className="group">
      ...
      <p className="mt-1 text-[11.5px] leading-relaxed text-mut">
        ...
        <span className="font-bold">and</span> the source shares concepts with your question (a very close match
        is cited regardless). Retrieval considers {pool} candidate chunks{docs != null ? ` across ${docs} indexed document${docs === 1 ? "" : "s"}` : ""}.

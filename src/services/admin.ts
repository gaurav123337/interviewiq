...
/* ------------------------------------------------------------------ */
/* Security (docs/app-security.md G8/G9 — supabase/security.sql)      */
/* ------------------------------------------------------------------ */
...
/** Owner-only: flip MFA enforcement for admin actions (app_config row). */
...
/** Append-only admin action log (config, announcements, admin changes). */

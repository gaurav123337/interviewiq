...
export type View = "landing" | "onboard" | "interview" | "results" | "drill" | "bank" | "history" | "settings" | "planner" | "roadmap" | "playground" | "admin" | "progress" | "team" | "account" | "legal" | "jobs" | "resources" | "counselor" | "systemDesign" | "learn" | "learn-detail" | "articles" | "sources";
...
export interface JobPosting {
  ...
  skills: string[];
  level: string | null;
  /** Salary band — "posting" = explicit range in the posting, "estimate" =
      provider lookup (labelled "est." in the UI, never fabricated). */
  salary: { min: number; max: number; currency: string; source?: "posting" | "estimate" } | null;
